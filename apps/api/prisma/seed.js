...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var user1, user2, user3, profile1, profile2, profile3, movie1, movie2, tvShow, family, invitationToken, sessionToken, refreshToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 20:
                    ...
                    return [4 /*yield*/, prisma.watchlistEntry.create({
                            data: {
                                userId: user1.id,
                ...
                case 24:
                    ...
                    return [4 /*yield*/, prisma.streamingProvider.create({
                            data: {
                                mediaItemId: movie1.id,
                                provider: 'netflix',
                                regions: ['US', 'CA', 'GB'],
                ...
                case 28:
                    family = _a.sent();
                    // Add family members
                    return [4 /*yield*/, prisma.familyMembership.create({
                            data: {
                                userId: user1.id,
                                familyId: family.id,
                                role: 'admin',
                ...
                case 30:
                    ...
                    return [4 /*yield*/, prisma.familyInvitation.create({
                            data: {
                                familyId: family.id,
                ...
                case 31:
                    ...
                    return [4 /*yield*/, prisma.recommendation.create({
                            data: {
                                mediaItemId: movie1.id,
                ...
                case 34:
                    ...
                    console.log("- Users: ".concat(user1.email, ", ").concat(user2.email, ", ").concat(user3.email));
                    console.log("- Media items: ".concat(movie1.title, ", ").concat(movie2.title, ", ").concat(tvShow.title));
